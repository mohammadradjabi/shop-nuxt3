<template>
  <div>
    <header class="page-header d-md-block d-none">
      <!-- start banner -->
      <div
        class="alert banner-container alert-dismissible fade show"
        role="alert"
      >
        <a
          href="#"
          class="banner-placement rounded-0"
          style="background-image: url(/images/banner/017.jpg); height: 60px"
        ></a>
        <button
          type="button"
          class="btn-close"
          ...
          <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center flex-grow-1 pe-3">
              ...
              <div class="search-container">
                <form action="#" class="search-form">
                  ...
                  <button
                    class="btn btn-primary btn-close-search-result btn-action d-none"
                  >
                ...
                <div class="search-result-container">
                  <div class="search-result-tags-container">
                    ...
                    <ul class="search-result-tags">
                      ...
                      <li>
                        <a href="#" class="search-result-tag"
                          >لوازم خانگی برقی</a
                        >
                      </li>
            ...
            <div class="user-options">
              <div class="user-option user-option--account">
                <a
                  href="profile.html"
                  class="user-option-btn user-option-btn--account"
                >
                        ...
                        <ul>
                          <li>
                            ...
                            <span class="detail">
                              <span class="d-block"
                                >۰
                                <span class="currency fs-7 fw-bold"
                                  >تومان</span
                                ></span
                              >
                              <a
                          ...
                          <li>
                            ...
                            <span class="detail">
                              <span class="d-block"
                                >۰
                                <span class="score text-muted fs-7"
                                  >امتیاز</span
                                ></span
                              >
                            </span>
              ...
              <div class="user-option user-option--cart">
                ...
                <div class="mini-cart">
                  <div class="mini-cart-header">
                    ...
                    <a href="cart.html" class="btn btn-link px-0"
          ...
          <div class="d-flex align-items-center">
            <div class="vertical-menu">
              <a href="#" class="vertical-menu-btn"
                >دسته بندی کالاها <i class="ri-apps-fill icon"></i
              ></a>
